 ...
 * @author Miguel
 */
public class vPBanco extends javax.swing.JFrame {

    /**
     * Creates new form vPBanco
     */
    ...
    public vPBanco() {
        ...
        BaseDatos.getInstance().cargarOfertasBanco(ofertas);
    ...
    public JPanel cargarPaneles(Oferta oferta){
        ...
        JLabel nombreLabel = new JLabel(Main.getIntance().getBanco().getNombre());
        ...
        JLabel borrarL = new JLabel("X");
        
        borrar.setBackground(new java.awt.Color(255, 255, 255));
        borrarL.setFont(new java.awt.Font("Segoe UI", 1, 14));
        borrarL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        borrarL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 0)));
        borrarL.setForeground(new java.awt.Color(255, 0, 0));
        
        javax.swing.GroupLayout verMasLayout = new javax.swing.GroupLayout(borrar);
        borrar.setLayout(verMasLayout);
        verMasLayout.setHorizontalGroup(
            verMasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(borrarL, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
        );
        verMasLayout.setVerticalGroup(
            verMasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(borrarL, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        );
        ...
        borrarL.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                 borrarL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        JLabel listadoL = new JLabel("Listado");
        
        listado.setBackground(new java.awt.Color(255, 255, 255));
        listadoL.setFont(new java.awt.Font("Segoe UI", 1, 14));
        listadoL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        listadoL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 153)));
        listadoL.setForeground(new java.awt.Color(0, 255, 153));
        
        javax.swing.GroupLayout verMasLayoutL = new javax.swing.GroupLayout(listado);
        listado.setLayout(verMasLayoutL);
        verMasLayoutL.setHorizontalGroup(
            verMasLayoutL.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(listadoL, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
        );
        verMasLayoutL.setVerticalGroup(
            verMasLayoutL.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(listadoL, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        );
        
        listado.add(listadoL);
        
        listadoL.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listadoInteres lI = new listadoInteres(oferta.getId());
                lI.setVisible(true);
                vPBanco.this.dispose();
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                 listadoL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
                 listado.setBackground(new java.awt.Color(0, 255, 153));
                 listadoL.setForeground(new java.awt.Color(255, 255, 255));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                 listadoL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 153)));
                 listado.setBackground(new java.awt.Color(255, 255, 255));
        ...
        panel.add(borrar, new AbsoluteConstraints(773, 217, 100, 43));
        panel.add(listado, new AbsoluteConstraints(650, 217, 100, 43));
    ...
    public void filtradoBusqueda(ArrayList<Oferta> ofertas){
        ...
        for(Oferta oferta : ofertas){
            if(oferta.getNombre().toLowerCase().contains(condicion)){
    ...
    private void initComponents() {
        ...
        crearOfertaL = new javax.swing.JLabel();
        ...
        crearOfertaL.setBackground(new java.awt.Color(0, 255, 153));
        crearOfertaL.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        crearOfertaL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        crearOfertaL.setText("+");
        crearOfertaL.setOpaque(true);
        crearOfertaL.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                crearOfertaLMouseClicked(evt);
            }
        });
        navbar2.add(crearOfertaL, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 6, 35, 40));
        ...
        navbar2.add(busc, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 310, 30));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(fondo, javax.swing.GroupLayout.DEFAULT_SIZE, 628, Short.MAX_VALUE)
        );
    ...
    private void crearOfertaLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_crearOfertaLMouseClicked
        this.dispose();
        creacionOfertas cO = new creacionOfertas();
        cO.setVisible(true);
    }//GEN-LAST:event_crearOfertaLMouseClicked
    ...
    private void buscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscActionPerformed
        ...
        this.filtradoBusqueda(ofertasBanco);
    ...
    private void usuarioBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usuarioBMouseClicked
        perfilBanco pB = new perfilBanco();
        pB.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vPBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel crearOfertaL;
