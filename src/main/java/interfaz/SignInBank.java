 ...
 * @author Miguel
 */
public class SignInBank extends javax.swing.JFrame {

    /**
     * Creates new form SignInBank
     */
    public SignInBank() {
        initComponents();
    ...
    private boolean validarCampos() {
        ...
        String telef = jTelef.getText();
        if(telef.length() != 9){
            JOptionPane.showMessageDialog(this, "El telefono debe ser de nueve digitos", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void initComponents() {
        ...
        jTelef = new javax.swing.JTextField();
        ...
        jHorario.setForeground(new java.awt.Color(102, 102, 102));
        jHorario.setText("Horario");
        jHorario.setToolTipText("");
        jHorario.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        jHorario.setOpaque(true);
        jHorario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jHorarioMousePressed(evt);
            }
        });
        ...
        jTelef.setForeground(new java.awt.Color(102, 102, 102));
        jTelef.setText("Teléfono");
        jTelef.setToolTipText("");
        jTelef.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        jTelef.setOpaque(true);
        jTelef.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jTelefMousePressed(evt);
            }
        });
        jTelef.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTelefActionPerformed(evt);
            }
        });

        jDireccion.setForeground(new java.awt.Color(102, 102, 102));
        jDireccion.setText("Dirección");
        jDireccion.setToolTipText("");
        jDireccion.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        jDireccion.setOpaque(true);
        jDireccion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jDireccionMousePressed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addComponent(jHorario, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(jTelef, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jHorario, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTelef, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addComponent(jDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 54, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SignB, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LogInB, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28))
        );

        fondo.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 460, 490));
    ...
    private void jNameMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jNameMousePressed
        ...
        if(jHorario.getText().isEmpty()){
            jHorario.setText("Horario");
            jHorario.setForeground(Color.gray);
        }
        if(jDireccion.getText().isEmpty()){
            jDireccion.setText("Dirección");
            jDireccion.setForeground(Color.gray);
        }
        if(jTelef.getText().isEmpty()){
            jTelef.setText("Teléfono");
            jTelef.setForeground(Color.gray);
        }
    ...
    private void SignBTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SignBTxtMouseClicked
        if(validarCampos()){
            BaseDatos.getInstance().guardarBanco(jName.getText(), jMail.getText(), jPass.getText(), 2, jTelef.getText(), jHorario.getText(), jDireccion.getText());
    ...
    private void jHorarioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jHorarioMousePressed
        
        if(jHorario.getText().equals("Horario")){
            jHorario.setText("");
            jHorario.setForeground(Color.black);
        }
        if(jMail.getText().isEmpty()){
            jMail.setText("Correo electrónico");
            jMail.setForeground(Color.black);
    ...
    }//GEN-LAST:event_jHorarioMousePressed
    ...
    private void jTelefMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTelefMousePressed
        if(jTelef.getText().equals("Teléfono")){
            jTelef.setText("");
            jTelef.setForeground(Color.black);
        }
        if(jMail.getText().isEmpty()){
            jMail.setText("Correo electrónico");
            jMail.setForeground(Color.black);
    ...
    }//GEN-LAST:event_jTelefMousePressed

    private void jTelefActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTelefActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTelefActionPerformed

    private void jDireccionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDireccionMousePressed
        if(jDireccion.getText().equals("Dirección")){
            jDireccion.setText("");
            jDireccion.setForeground(Color.black);
        }
        if(jMail.getText().isEmpty()){
            jMail.setText("Correo electrónico");
            jMail.setForeground(Color.black);
    ...
    }//GEN-LAST:event_jDireccionMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignInBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignInBank().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTelef;
