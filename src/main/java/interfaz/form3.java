...
public class form3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        preguntaTxt.setText("¿Cuál es el valor de la vivienda?");
        ...
        sigB4Layout.setHorizontalGroup(
            ...
            .addComponent(sigTxt4, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        sigB6Layout.setVerticalGroup(
            sigB6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(sigTxt6, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
        );
    ...
    private void sigTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sigTxtMouseClicked
        ...
        if(sigB4.getBackground().equals(colorP)){
            Main.getIntance().getUsuarioActivo().setValorVivienda(sigTxt4.getText());
        }
        else if(sigB5.getBackground().equals(colorP)){
            Main.getIntance().getUsuarioActivo().setValorVivienda(sigTxt5.getText());
        }
        else if(sigB6.getBackground().equals(colorP)){
            Main.getIntance().getUsuarioActivo().setValorVivienda(sigTxt6.getText());
        }
        else if(sigB7.getBackground().equals(colorP)){
            Main.getIntance().getUsuarioActivo().setValorVivienda(sigTxt7.getText());
        }
        else{
            cancelar = true;
        }
